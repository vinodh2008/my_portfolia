        ...
        <div className="grid md:grid-cols-2 gap-8 justify-center">
          {certificates.map((cert, index) => (
            <motion.a
              ...
              className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:scale-[1.03] transition-all duration-300 transform flex items-center justify-center text-center group"
            >
              <h3 className="text-xl font-bold text-slate-800 group-hover:text-[#2b6cb0] transition-colors">
                {cert.title}
              </h3>
            </motion.a>
          ))}
